...
fun main() {
    ...
    alanKarsilastir(kare1,kare2)

    var dikdortgen1=Dikdortgen(6,15)
    var dikdortgen2=Dikdortgen(8,20)
   ...
   var gs2: GeometrikSekil= Kare(14)
    ...
    println("Büyük alan : " + GenerikAlanKarsilastirFun(sekil1,sekil2).alanHesapla())
}

fun <Genel:GeometrikSekil> GenerikAlanKarsilastirFun(sekil1:Genel, sekil2:Genel) : Genel{
